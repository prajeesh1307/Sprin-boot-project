...
public class ShirtService {
	...
	public List<Shirt>fetchShirtByBran(String suffix)
	{
	...
	@Transactional
	public int deleteShirtColor(String color)
	{
		return sr.deleteShirtByColor(color);
	}
	@Transactional
	public int updateShirtColor(String color,String brand)
	{
		return sr.updateShirtByColor(color,brand);
	}
